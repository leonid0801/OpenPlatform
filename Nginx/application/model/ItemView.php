 ...
 *
 */
class ItemView extends DBModel {
    ...
    public function increaseView($itemId){
        //update cmf_posts set post_hits=post_hits+'1' where id=41
        $sql="update t_view set f_count=f_count+'1' where f_itemid='{$itemId}'";
    ...
    public function getCountByFid($item_id){
        return $this->select(Array("f_count"), "f_itemid='{$item_id}'");
    }
